    ...
    <div className="min-h-screen py-12 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-3xl md:text-5xl font-semibold mb-6 tracking-tight text-warm-text leading-tight">
          ...
          <p className="text-warm-secondary text-lg mb-8 leading-relaxed">
            This paper presents a comprehensive study on automated coronary artery stenosis analysis using deep learning models and explainable AI techniques.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button className="btn-primary flex items-center space-x-2 px-6 py-3 rounded-md">
              <Download className="w-4 h-4" />
              <span>Download PDF</span>
            </button>
            <button className="border border-warm-border px-6 py-3 rounded-md text-warm-text font-medium hover:bg-warm-bgAlt transition-colors flex items-center space-x-2">
        ...
        <motion.div
          ...
          className="card rounded-lg p-6 mb-10 border border-warm-border"
        >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
            {sections.map((section) => (
              <a
                key={section.id}
                href={`#${section.id}`}
                className="flex items-center space-x-3 p-3 rounded-lg hover:bg-warm-bgAlt transition-colors group"
              >
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          className="card rounded-lg p-8 mb-6 border border-warm-border"
        >
          <div className="flex items-center space-x-3 mb-6">
            <div className="w-10 h-10 rounded-lg bg-warm-primary flex items-center justify-center">
              <FileText className="w-5 h-5 text-white" />
            </div>
            <h2 className="text-2xl font-semibold text-warm-text">Abstract</h2>
          </div>
        ...
        >
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-warm-text">Introduction</h2>
          </div>
        ...
        >
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-2xl font-semibold text-warm-text">Methodology</h2>
          </div>
            ...
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4 mt-4">
                {[
                  ...
                  <div key={i} className="card rounded-lg p-4 bg-warm-bgAlt border border-warm-border">
