      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center space-x-2 glass-card px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm text-gray-300">Research Paper</span>
          </div>
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Stenosis Detection and Segmentation in Coronary Arteries using <span className="gradient-text">YOLOv8</span>
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button className="glass-card px-6 py-3 rounded-lg text-white hover:bg-white/10 transition-all flex items-center space-x-2">
        ...
        >
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
            {sections.map((section, index) => (
              ...
              >
                <section.icon className="w-5 h-5 text-medical-400 group-hover:text-medical-300" />
                <span className="text-sm text-gray-300 group-hover:text-white">{section.title}</span>
              </a>
            ))}
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 mt-4">
            {['Deep Learning', 'YOLOv8', 'Coronary Artery', 'Stenosis Detection', 'Medical Imaging', 'XAI'].map(tag => (
              <span key={tag} className="px-3 py-1 rounded-full text-xs bg-medical-500/10 text-medical-400 border border-medical-500/20">
                {tag}
              </span>
            ))}
          </div>
        ...
        >
          ...
          <div className="space-y-6 text-gray-300">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Overall Pipeline</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Preprocessing</h3>
              <p className="leading-relaxed">
                Input images were resized to 640×640 pixels and normalized using ImageNet mean and standard deviation.
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Training Configuration</h3>
              <div className="grid sm:grid-cols-2 gap-4 mt-4">
                <div className="glass-card rounded-xl p-4">
                  <p className="text-sm text-gray-400 mb-2">Optimizer</p>
                  <p className="text-white font-medium">AdamW</p>
                </div>
                <div className="glass-card rounded-xl p-4">
                  <p className="text-sm text-gray-400 mb-2">Learning Rate</p>
                  <p className="text-white font-medium">0.001 (cosine decay)</p>
                </div>
                <div className="glass-card rounded-xl p-4">
                  <p className="text-sm text-gray-400 mb-2">Batch Size</p>
                  <p className="text-white font-medium">16</p>
                </div>
                <div className="glass-card rounded-xl p-4">
                  <p className="text-sm text-gray-400 mb-2">Epochs</p>
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-white">Dataset (ARCADE)</h2>
          </div>
          <div className="space-y-4 text-gray-300">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-4">
              ...
              <div className="glass-card rounded-xl p-4 text-center">
                <p className="text-3xl font-bold gradient-text">1,523</p>
                <p className="text-sm text-gray-400 mt-1">Stenosis Cases</p>
              </div>
              <div className="glass-card rounded-xl p-4 text-center">
                <p className="text-3xl font-bold gradient-text">80/20</p>
                <p className="text-sm text-gray-400 mt-1">Train/Test Split</p>
              </div>
            </div>
            <p>
        ...
        >
          <div className="flex items-center space-x-3 mb-4">
            ...
            <h2 className="text-2xl font-bold text-white">Model Architecture (YOLOv8)</h2>
          </div>
          <div className="space-y-4 text-gray-300">
            <p>
            ...
            <div className="grid md:grid-cols-3 gap-4 mt-4">
              <div className="glass-card rounded-xl p-4">
                <h4 className="text-medical-400 font-semibold mb-2">YOLOv8n/n-seg</h4>
                <p className="text-sm text-gray-400">Nano variant with 3.0M parameters, optimized for edge deployment and real-time inference.</p>
              </div>
              <div className="glass-card rounded-xl p-4">
                <h4 className="text-medical-400 font-semibold mb-2">YOLOv8s/s-seg</h4>
                <p className="text-sm text-gray-400">Small variant with 11.2M parameters, balancing accuracy and computational efficiency.</p>
              </div>
              <div className="glass-card rounded-xl p-4">
                <h4 className="text-medical-400 font-semibold mb-2">YOLOv8m/m-seg</h4>
                <p className="text-sm text-gray-400">Medium variant with 25.9M parameters, achieving highest accuracy for clinical applications.</p>
              </div>
            </div>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="space-y-6 text-gray-300">
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Detection Performance</h3>
              <p className="leading-relaxed mb-4">
                YOLOv8m achieved the highest mAP50 of 86.7% with precision of 0.89 and recall of 0.84. The nano variant
                (YOLOv8n) demonstrated competitive performance with 78.2% mAP50 while being 3.75× faster in inference,
                making it suitable for resource-constrained environments.
              </p>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Segmentation Performance</h3>
              <p className="leading-relaxed mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white mb-3">Explainability Analysis</h3>
              <p className="leading-relaxed">
